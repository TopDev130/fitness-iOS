...
static const CGFloat kLabelsFontSize = 11.0f;

@implementation ERRangeSlider
...
- (void)initialiseControl {
    ...
    self.sliderLine.backgroundColor = [UIColor colorWithRed: 0 green: 199.0/255.0 blue:0 alpha: 1.0].CGColor;
    ...
    self.leftHandle.backgroundColor = [UIColor colorWithRed: 0 green: 199.0/255.0 blue:0 alpha: 1.0].CGColor;
    ...
    self.rightHandle.backgroundColor = [UIColor colorWithRed: 0 green: 199.0/255.0 blue:0 alpha: 1.0].CGColor;
    ...
    self.minLabelColour = [UIColor colorWithRed: 0 green: 199.0/255.0 blue:0 alpha: 1.0];
    self.maxLabelColour = [UIColor colorWithRed: 0 green: 199.0/255.0 blue:0 alpha: 1.0];
    
    self.minLabel = [[CATextLayer alloc] init];
    self.minLabel.alignmentMode = kCAAlignmentCenter;
    self.minLabel.fontSize = kLabelsFontSize;
    self.minLabel.font = CFBridgingRetain([UIFont fontWithName: @"CenturyGothic" size: kLabelsFontSize].fontName);
    ...
    self.maxLabel.font = CFBridgingRetain([UIFont fontWithName: @"CenturyGothic" size: kLabelsFontSize].fontName);
